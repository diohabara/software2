...
void plot_objects(Object objs[], const size_t numobj, const double t,
                  const Condition cond);
void update_velocities(Object objs[], const size_t numobj,
                       const Condition cond);
...
// my_plot_objects(), my_update_velocities(), my_update_positions(), my_bounce
// の4つ
